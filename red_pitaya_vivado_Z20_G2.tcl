...
#
# Usage:
# vivado -mode tcl -source red_pitaya_vivado_Z20_G2.tcl -tclargs projectname
################################################################################
...
if {$prj_name != "pyrpl"} {
    ...
    add_files -fileset constrs_1      $path_sdc/red_pitaya_G2.xdc
}
...
if {[file exists $path_sdc_prj/red_pitaya_G2.xdc]} {
