...
proc create_root_design { parentCell } {
  ...
  set M_AXI_GP0_ACLK [ create_bd_port -dir I -type clk -freq_hz 122880000 M_AXI_GP0_ACLK ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M_AXI_GP0} \
 ] $M_AXI_GP0_ACLK
  set M_AXI_STR_TX0_aclk [ create_bd_port -dir I -type clk -freq_hz 122880000 M_AXI_STR_TX0_aclk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {M_AXI_STR_TX0_arstn} \
 ] $M_AXI_STR_TX0_aclk
  set M_AXI_STR_TX0_arstn [ create_bd_port -dir I -type rst M_AXI_STR_TX0_arstn ]
  set M_AXI_STR_TX1_aclk [ create_bd_port -dir I -type clk -freq_hz 122880000 M_AXI_STR_TX1_aclk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {M_AXI_STR_TX1_arstn} \
 ] $M_AXI_STR_TX1_aclk
  set M_AXI_STR_TX1_arstn [ create_bd_port -dir I -type rst M_AXI_STR_TX1_arstn ]
  set M_AXI_STR_TX2_aclk [ create_bd_port -dir I -type clk -freq_hz 122880000 M_AXI_STR_TX2_aclk ]
  set_property -dict [ list \
  ...
  set S_AXI_STR_RX0_aclk [ create_bd_port -dir I -type clk -freq_hz 122880000 S_AXI_STR_RX0_aclk ]
  set_property -dict [ list \
  ...
  set S_AXI_STR_RX1_aclk [ create_bd_port -dir I -type clk -freq_hz 122880000 S_AXI_STR_RX1_aclk ]
  set_property -dict [ list \
  ...
  set S_AXI_STR_RX2_aclk [ create_bd_port -dir I -type clk -freq_hz 122880000 S_AXI_STR_RX2_aclk ]
  set_property -dict [ list \
