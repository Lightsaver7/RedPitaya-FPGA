...
################################################################
set scripts_vivado_version 2024.3
...
proc create_root_design { parentCell } {
  ...
  set HK_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 HK_AXI ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {20} \
   CONFIG.CLK_DOMAIN {system_processing_system7_0_0_FCLK_CLK2} \
  ...
  set adc_clk0 [ create_bd_port -dir I -type clk -freq_hz 125000000 adc_clk0 ]
  set adc_clk1 [ create_bd_port -dir I -type clk -freq_hz 125000000 adc_clk1 ]
  ...
  set adc_data_ch3 [ create_bd_port -dir I -from 13 -to 0 adc_data_ch3 ]
  set adc_data_ch4 [ create_bd_port -dir I -from 13 -to 0 adc_data_ch4 ]
  set clk_out125_0 [ create_bd_port -dir O -type clk clk_out125_0 ]
  set gpio_trig [ create_bd_port -dir O gpio_trig ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {125000000} \
 ] $clk_out125_0
  set clk_out125_1 [ create_bd_port -dir O -type clk clk_out125_1 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {125000000} \
 ] $clk_out125_1
  ...
  set rstn_out_0 [ create_bd_port -dir O -type rst rstn_out_0 ]
  set rstn_out_1 [ create_bd_port -dir O -type rst rstn_out_1 ]
  set rstn_saxi [ create_bd_port -dir O -type rst rstn_saxi ]
  ...
  set_property CONFIG.ASSOCIATED_BUSIF {HK_AXI} [get_bd_ports /FCLK_CLK2]
  set spi_done [ create_bd_port -dir I spi_done ]
  ...
  set clk_gen0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_gen0 ]
  set_property -dict [ list \
  ...
  # Create instance: clk_gen1, and set properties
  set clk_gen1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_gen1 ]
  set_property -dict [ list \
   CONFIG.CLKIN1_JITTER_PS {80.0} \
   CONFIG.CLKOUT1_REQUESTED_PHASE {180.000} \
   CONFIG.CLKOUT1_JITTER {119.348} \
  ...
  connect_bd_intf_net -intf_net axi_reg_M01_AXI [get_bd_intf_pins axi_reg/M01_AXI] [get_bd_intf_pins rp_gpio/s_axi_reg]
  connect_bd_intf_net -intf_net axi_reg_M02_AXI [get_bd_intf_pins axi_reg/M02_AXI] [get_bd_intf_ports HK_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins axi_reg/S00_AXI]
  ...
  connect_bd_intf_net -intf_net rp_oscilloscope_m_axi_osc3 [get_bd_intf_pins axi_interconnect_3/S00_AXI] [get_bd_intf_pins rp_oscilloscope/m_axi_osc3]
  connect_bd_intf_net -intf_net rp_oscilloscope_m_axi_osc4 [get_bd_intf_pins axi_interconnect_3/S01_AXI] [get_bd_intf_pins rp_oscilloscope/m_axi_osc4]

  # Create port connections
  #connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_reg/ARESETN] [get_bd_pins rst_gen/interconnect_aresetn]
  ...
  #connect_bd_net -net M00_ARESETN_1 [get_bd_ports rstn_out_0] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_2/ARESETN] [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_2/S00_ARESETN] [get_bd_pins axi_interconnect_2/S01_ARESETN] [get_bd_pins axi_reg/M00_ARESETN] [get_bd_pins axi_reg/M02_ARESETN] [get_bd_pins axi_reg/M03_ARESETN] [get_bd_pins axi_reg/S00_ARESETN] [get_bd_pins rp_gpio/m_axi_gpio_in_aresetn] [get_bd_pins rp_gpio/m_axi_gpio_out_aresetn] [get_bd_pins rp_gpio/rst_n] [get_bd_pins rp_gpio/s_axi_reg_aresetn] [get_bd_pins rp_oscilloscope/m_axi_osc1_aresetn] [get_bd_pins rp_oscilloscope/m_axi_osc2_aresetn] [get_bd_pins rp_oscilloscope/rst_n] [get_bd_pins rp_oscilloscope/s_axi_reg_aresetn] [get_bd_pins rst_gen/peripheral_aresetn] [get_bd_pins xadc/s_axi_aresetn]
  ...
  connect_bd_net -net adc_clk1_1 [get_bd_ports adc_clk1] [get_bd_pins clk_gen1/clk_in1]
  connect_bd_net -net adc_clk_1 [get_bd_ports adc_clk0] [get_bd_pins clk_gen0/clk_in1]
  ...
  connect_bd_net -net adc_data_ch3_1 [get_bd_ports adc_data_ch3] [get_bd_pins rp_oscilloscope/adc_data_ch3]
  connect_bd_net -net adc_data_ch4_1 [get_bd_ports adc_data_ch4] [get_bd_pins rp_oscilloscope/adc_data_ch4]
  connect_bd_net -net slave_mode_in [get_bd_ports daisy_slave] [get_bd_pins rp_oscilloscope/daisy_slave_i]

  set resets_osc1_rstgen [list \
  [get_bd_pins rst_gen/peripheral_aresetn] \
  [get_bd_ports rstn_out_0] \
  ...
  [get_bd_pins axi_interconnect_3/S01_ARESETN] \
  ...
  connect_bd_net -net osc1_reset $resets_osc1_rstgen


  set resets_fclk2_rstgen3 [list \
  [get_bd_pins rst_gen3/interconnect_aresetn] \
  [get_bd_ports rstn_saxi] \
  ...
  connect_bd_net -net fclk2_reset $resets_fclk2_rstgen3

  set clks_osc1 [list \
  [get_bd_pins clk_gen0/clk_125] \
  [get_bd_ports clk_out125_0] \
  ...
  connect_bd_net -net osc1_clk $clks_osc1
  ...
  connect_bd_net -net fclk2_clk $clks_fclk2

  #connect_bd_net -net clk_gen0_clk_125 [get_bd_ports clk_out125_0] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/M00_ACLK] [get_bd_pins axi_interconnect_2/S00_ACLK] [get_bd_pins axi_interconnect_2/S01_ACLK] [get_bd_pins axi_reg/M00_ACLK] [get_bd_pins axi_reg/M02_ACLK] [get_bd_pins axi_reg/M03_ACLK] [get_bd_pins clk_gen0/clk_125] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins rp_gpio/clk] [get_bd_pins rp_gpio/m_axi_gpio_in_aclk] [get_bd_pins rp_gpio/m_axi_gpio_out_aclk] [get_bd_pins rp_gpio/s_axi_reg_aclk] [get_bd_pins rp_oscilloscope/clk] [get_bd_pins rp_oscilloscope/m_axi_osc1_aclk] [get_bd_pins rp_oscilloscope/m_axi_osc2_aclk] [get_bd_pins rp_oscilloscope/s_axi_reg_aclk] [get_bd_pins xadc/s_axi_aclk]
  #connect_bd_net [get_bd_pins axi_interconnect_3/ACLK] [get_bd_pins axi_interconnect_3/M00_ACLK] [get_bd_pins axi_interconnect_3/S00_ACLK] [get_bd_pins axi_interconnect_3/S01_ACLK] [get_bd_pins clk_gen0/clk_125] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP3_ACLK] [get_bd_pins rp_oscilloscope/m_axi_osc3_aclk] [get_bd_pins rp_oscilloscope/m_axi_osc4_aclk] [get_bd_pins rst_gen2/slowest_sync_clk] [get_bd_pins axi_reg/M01_ACLK]
  connect_bd_net -net clk_gen1_clk_125 [get_bd_ports clk_out125_1] [get_bd_pins clk_gen1/clk_125] [get_bd_pins rst_gen2/slowest_sync_clk]
  #connect_bd_net -net clk_gen_clk_62_5 [get_bd_pins axi_reg/ACLK] [get_bd_pins axi_reg/S00_ACLK] [get_bd_pins clk_gen0/clk_62_5] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_gen/slowest_sync_clk]
  connect_bd_net -net loopback_sel_scope [get_bd_ports loopback_sel] [get_bd_pins rp_oscilloscope/loopback_sel]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_ports FCLK_RESET0_N] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_gen/ext_reset_in] [get_bd_pins rst_gen2/ext_reset_in] [get_bd_pins rst_gen3/ext_reset_in]
  ...
  connect_bd_net -net rp_concat_0_event_reset [get_bd_pins rp_concat/event_reset] [get_bd_pins rp_gpio/event_ip_reset] [get_bd_pins rp_oscilloscope/event_ip_reset]
  connect_bd_net -net rp_concat_0_event_start [get_bd_pins rp_concat/event_start] [get_bd_pins rp_gpio/event_ip_start] [get_bd_pins rp_oscilloscope/event_ip_start]
  connect_bd_net -net rp_concat_0_event_stop [get_bd_pins rp_concat/event_stop] [get_bd_pins rp_gpio/event_ip_stop] [get_bd_pins rp_oscilloscope/event_ip_stop]
  connect_bd_net -net rp_concat_event_trig [get_bd_pins rp_concat/event_trig] [get_bd_pins rp_gpio/event_ip_trig] [get_bd_pins rp_oscilloscope/event_ip_trig]
  connect_bd_net -net rp_concat_ext_trig_ip [get_bd_ports trig_in] [get_bd_pins rp_concat/ext_trig_ip]
  connect_bd_net -net rp_concat_trig [get_bd_pins rp_concat/trig] [get_bd_pins rp_gpio/trig_ip] [get_bd_pins rp_oscilloscope/trig_ip]
  ...
  connect_bd_net -net rp_oscilloscope_intr [get_bd_pins intr_concat/In15] [get_bd_pins rp_oscilloscope/intr]
  connect_bd_net -net rp_oscilloscope_osc1_event_op [get_bd_pins rp_concat/osc1_event_ip] [get_bd_pins rp_oscilloscope/osc1_event_op]
  connect_bd_net -net rp_oscilloscope_osc1_trig_op [get_bd_pins rp_concat/osc1_trig_ip] [get_bd_pins rp_oscilloscope/osc1_trig_op]
  connect_bd_net -net rp_oscilloscope_osc2_event_op [get_bd_pins rp_concat/osc2_event_ip] [get_bd_pins rp_oscilloscope/osc2_event_op]
  connect_bd_net -net rp_oscilloscope_osc2_trig_op [get_bd_pins rp_concat/osc2_trig_ip] [get_bd_pins rp_oscilloscope/osc2_trig_op]
  connect_bd_net [get_bd_ports spi_done] [get_bd_pins clk_gen0/resetn] [get_bd_pins clk_gen1/resetn]

  connect_bd_net -net rp_oscilloscope_osc3_event_op [get_bd_pins rp_concat/gen1_event_ip] [get_bd_pins rp_oscilloscope/osc3_event_op]
  connect_bd_net -net rp_oscilloscope_osc3_trig_op [get_bd_pins rp_concat/gen1_trig_ip] [get_bd_pins rp_oscilloscope/osc3_trig_op]
  connect_bd_net -net rp_oscilloscope_osc4_event_op [get_bd_pins rp_concat/gen2_event_ip] [get_bd_pins rp_oscilloscope/osc4_event_op]
  connect_bd_net -net rp_oscilloscope_osc4_trig_op [get_bd_pins rp_concat/gen2_trig_ip] [get_bd_pins rp_oscilloscope/osc4_trig_op]
  connect_bd_net [get_bd_pins rst_gen/dcm_locked] [get_bd_pins rst_gen2/dcm_locked] [get_bd_pins clk_gen0/locked]
  connect_bd_net [get_bd_pins rst_gen3/dcm_locked] [get_bd_pins clk_gen1/locked]
  connect_bd_net -net rp_oscilloscope_0_clksel [get_bd_ports clksel] [get_bd_pins rp_oscilloscope/clksel_o]

  connect_bd_net -net rst_gen2_peripheral_aresetn [get_bd_ports rstn_out_1] [get_bd_pins rst_gen2/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x40300000 -range 0x00100000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs HK_AXI/Reg] -force
  assign_bd_address -offset 0x40200000 -range 0x00100000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs rp_gpio/s_axi_reg/reg0] -force
  assign_bd_address -offset 0x40000000 -range 0x00100000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs rp_oscilloscope/s_axi_reg/reg0] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces rp_gpio/axi_gpio_in] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces rp_gpio/axi_gpio_out] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces rp_oscilloscope/m_axi_osc3] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces rp_oscilloscope/m_axi_osc4] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] -force
